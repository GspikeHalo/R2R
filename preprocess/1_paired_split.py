...
def main():
    ...
    parser.add_argument(
        '--root',
        default='/media/Data_2/R2RResult/odb-full-v1/paired',   # input pair-tree
        help='Input root of the pair-tree (default: ./paired).'
    )
    parser.add_argument(
        '--out_root',
        default='/media/Data_2/R2RResult/odb-full-v1/processed/test',  # output root
        help='Output root where the mirrored pair-tree will be written (default: ./paired_out).'
    )
    parser.add_argument(
        '--type',
        choices=['split', 'zoom'],
